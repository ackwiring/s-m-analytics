...
export default function DragDropCanvas({ onUpload, isUploading, children }) {
  ...
  return (
    ...
    >
      ...
      {isDragging && (
        <div className="fixed inset-0 z-50 bg-[#0a192f]/90 flex flex-col items-center justify-center p-8 backdrop-blur-sm border-4 border-dashed border-[#ea580c] pointer-events-none select-none">
